...
Screen:
    ...
    MDTextField:
        ...
        helper_text: "To be Separated by comma"
    ...
    MDTextField:
        id: xtt
        hint_text: 'Respective f(x) values'
    ...
    MDTextField:
        id: ott
        hint_text: 'x where f(x) is needed'
        pos_hint: {'center_x': 0.5, 'center_y': 0.4}
        helper_text: "Rounded to 8 characters"
